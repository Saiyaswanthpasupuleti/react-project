...
export function Signup() {
    ...
    // Handle confirm password to ensure it matches the password
            ...
            <div className="container d-flex justify-content-center align-items-center" style={{ minHeight: "80vh" }}>
                <div 
                    ...
                    style={{ 
                        ...
                        borderRadius: "15px",
                        backdropFilter: "blur(15px)" // Adjusted blur effect for smoother background
                    }}
                >
                    <h1 className="text-center mb-4" style={{ fontSize: '2.5rem', color: "#28a745" }}>Sign Up</h1>
                    <form onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="btn btn-success w-100" style={{ fontSize: '1.2rem', padding: '12px' }}>
                            Sign Up
                        </button>
                    </form>
                    <p
